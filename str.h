...
extern char *Str_cat(const char *s1, int i1, int j1, const char char *s2, int i2, int j2);
...
extern void Str_fmt(int code, va_list *app, int put(int c, void *c1), void *c1, unsigned char flags[], int width, int precision);
